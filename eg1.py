...
if (choice == 'D'):
    ...
    for i in numbers:
        if i not in NewList:
            NewList.append(i)
        elif i not in DupItem:
            DupItem.append(i)
    print(DupItem)        #on choice-D user will get number of duplicate numbers
...
if (choice == 'E'):
    ...
    for i in numbers:
        if i not in tempList:
            tempList.append(i)
    print(tempList)         #on choice-E user can Display list without duplicate numbers
